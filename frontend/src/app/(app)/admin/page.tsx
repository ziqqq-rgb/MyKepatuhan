...
import { apiQuery, apiGetConversationMessages, apiGetMe } from "@/lib/api";
...
export default function ChatPage() {
  ...
  // Admins land on the upload/admin page, not the chat page — only
  // non-admin users are allowed here.
  useEffect(() => {
    apiGetMe()
      .then((me) => {
        if (me.is_admin) {
